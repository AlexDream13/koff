export class Pagination{
    ...
    update({currentPage, totalPages, totalProducts,limit}){
      ...
      this.paginationCurrent.textContent = totalProducts === limit ? totalProducts : width < totalProducts ? width : width - limit + (totalProducts % limit);
    ...
    createPagination(){
        ...
        this.paginationLeft.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" viewBox="0 0 8 14" fill="none">
        ...
        this.paginationRight.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
